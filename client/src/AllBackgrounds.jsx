      ...
      <div>
        <div style={{position:'fixed', zIndex:3, right:'3.5%', top:'10.5%',
          ...
          <div style={{display:'flex'}}>
            <button style={{marginLeft:'1%', width: '7vw',fontSize: "calc(7px + 0.35vw)"}} onClick={this.displayImage}>Display Image</button>
            <button style={{marginLeft:'1%', width: '7vw',fontSize: "calc(7px + 0.35vw)"}} onClick={this.addMedia}>Add To List</button>
            <button style={{marginLeft:'1%', width: '10vw',fontSize: "calc(7px + 0.35vw)"}} onClick={this.setItemBackground}>Set Item Background</button>
