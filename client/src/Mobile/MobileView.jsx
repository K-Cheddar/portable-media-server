...
export default class MobileView extends Component{
  ...
  render() {
    ...
    let menuItem = {
      display:'inline-block', height: '5vh', width:'95%', backgroundColor:'#06d1d1', margin: '10% 2.5%',
      fontSize: "calc(8px + 0.75vw)", color: 'black'
    }
    let connectedIcon = {marginLeft:'0.5vw', width:'5vw', height:'3.85vw', margin: 'auto', display:'block'}
    let menuStyle = {backgroundColor:'#383838', position:'absolute', width:'22vw', top:'5.5vh', left:'4.25vw',
    zIndex: 3}
    return (
      <div style={{width:'100%', overflow:'hidden', height:'100vh', backgroundColor:'#383838',
        position: 'fixed'}} onClick={this.closeMenu}>
        <div style={{width:'100%', height:'5vh', paddingTop:'0.5vh', paddingBottom:'0.5vh',
          backgroundColor:'#06d1d1', display:'flex'}}>
          ...
          <button style={buttonLoggedIn}
            ...
            >Change Item</button>
          {freeze && <div style={{display:'flex', margin:'auto'}}>
              <button style={buttonLoggedIn} onClick={toggleFreeze}>Unfreeze</button>
              <img style={{width: '12vw', height: '5.52vw', margin: '1vh 1vw'}}
                 alt="off" src={off}/>
              </div>
            }
            {!freeze && <div style={{display:'flex', margin:'auto'}}>
        ...
        {this.state.itemSelectOpen &&
          <div style={{position:'fixed', top:0, left:0, height:'100vh',
            ...
            <div style={{position:'fixed', display:'flex', top:'2vmax', left:'13vw',
               zIndex: 3, backgroundColor:'#383838', width:'70vw', maxWidth:'100%',
             color: 'white'}}>
