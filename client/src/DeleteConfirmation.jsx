  ...
  return(
    <div style={style}>
      ...
      <div style={{width:"20%", margin:'auto', textAlign:'center', display:'flex'}}>
        <button style={{margin:'auto', fontSize: 'calc(10px + 0.7vmax)'}} onClick={props.confirm}>Delete</button>
        <button style={{margin:'auto', fontSize: 'calc(10px + 0.7vmax)'}} onClick={props.cancel}>Cancel</button>
      </div>
